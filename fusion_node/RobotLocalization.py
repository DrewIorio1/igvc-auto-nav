"""
    ...
    History:
        ...
        5/30/2025 AI - Modified code to support ros rather then webots.
                     - Ensured that imu and motors get set during update
"""
import math
import logging
...
class RobotLocalization:
    ...
    def __init__(self, time_step, wheel_base_width, wheel_radius, left_motor, right_motor, imu=None):
        ...
        #logging.basicConfig(level=logging.INFO | logg)
    ...
    def set_location(self, imu, left, right):
        """
            Set the localization parameters need

            Args:
                imu - the for get the posion headed
    ...
    def update(self):
        ...
        """
        # 1) read encoders
        left_position = self.left_encoder
        right_position = self.right_encoder
        ...
        if self.imu:
            ...
            self.heading = (self.heading + math.pi) % (2*math.pi) - math.pi
            logging.warning(f"IMU Yaw: {imu_yaw}, Old Heading: {old_heading}, New Heading: {self.heading}")
